...
// Implements TPCH Q1 without filter or group by, just the aggregation part
// Uses SIMD
...
void ExpressionPerfComparisons(int* orderkeyArray,float* extendedPriceDataArray,
                    float* discountDataArray, float* taxDataArray,int datasize, int loopCount)
{
...
int main() {
    ...
    // Compare performance of different expressions evaluations
    ExpressionPerfComparisons(  orderkeyArray, extendedPriceDataArray,
